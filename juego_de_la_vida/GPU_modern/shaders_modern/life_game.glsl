...
void main(){
    ...
    if (current_state > 0.5){// Si esta vivo
        if (live_neighbors == 4 || live_neighbors == 5){// Si tiene 2 o 3 vecinos vivos, sigue vivo (ir cambiando el numero maximo)
        ...
        if (live_neighbors == 5){// Si tiene exactamente 3 vecinos vivos, nace
            new_state = 1.0;
